function StatusJogo({ nivel, pontos }) {
    ...
    return (
        <div>
            ...
            <div style={{ width: '200px', height: '20px', backgroundColor: '#ddd', borderRadius: '10px', overflow: 'hidden' }}>
                <div style={{ width: `${progresso}%`, backgroundColor: corBarra, height: '100%', transition: 'all 0.3s ease' }}></div>
            </div>
